...
.rl-stage .scene-visual{position:relative;width:600px;transform-origin:top center}
...
(function(){
  ...
  function fitMock(c){
    ...
    s=Math.max(1, Math.min(s, 2.6));               // agrandit le mock-up jusqu'à remplir le cadre

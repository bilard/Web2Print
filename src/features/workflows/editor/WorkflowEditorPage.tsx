...
export function WorkflowEditorPage() {
  ...
  if (loading) return <div className="min-h-screen bg-[#1c1c1c] text-white p-8">Chargement…</div>
  if (!wf) return <div className="min-h-screen bg-[#1c1c1c] text-white p-8">Workflow introuvable</div>

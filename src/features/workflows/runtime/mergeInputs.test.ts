...
describe('mergeInputValue (fan-in, parité serveur)', () => {
  ...
  it('une sheet vide n’efface pas une sheet pleine', () => {
  ...
  it('non-fusionnable → dernière valeur', () => {

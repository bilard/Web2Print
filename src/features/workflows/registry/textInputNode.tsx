  ...
  return (
    <div className="space-y-2">
      ...
      <textarea
        ...
        className="w-full bg-background border border-neutral-700 rounded-md px-2 py-1.5 text-[12px] text-white placeholder:text-neutral-600 focus:border-cyan-500 outline-none resize-y font-mono"
      />

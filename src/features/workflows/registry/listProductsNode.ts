  ...
  configSchema: [
    {
      name: 'urls',
      kind: 'textarea',
      labelKey: 'node.list-products.f1',
      required: true,
      helpKey: 'node.list-products.f2',
    },
    {
      name: 'family',
      kind: 'text',
      labelKey: 'node.list-products.f3',
      default: '',
      helpKey: 'node.list-products.f11',
    },
    {
      name: 'maxProducts',
      kind: 'number',
      labelKey: 'node.list-products.f4',
      default: 40,
      helpKey: 'node.list-products.f5',
    },
    {
      name: 'maxPages',
      kind: 'number',
      labelKey: 'node.list-products.f6',
      default: 1,
      helpKey: 'node.list-products.f7',
    },
    {
      name: 'pageParam',
      kind: 'text',
      labelKey: 'node.list-products.f8',
      default: 'page',
      helpKey: 'node.list-products.f9',
    },
    {
      name: 'enrichFiches',
      kind: 'checkbox',
      labelKey: 'node.list-products.f10',
      default: true,
      helpKey: 'node.list-products.familyHelp',
    },
    {
      name: 'marque',
      kind: 'text',
      labelKey: 'node.list-products.f12',
      default: '',
      helpKey: 'node.list-products.f13',
    },
  ],

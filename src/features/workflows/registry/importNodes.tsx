  ...
  return (
    <div className="space-y-2">
      ...
      {!hasFile ? (
        <>
          <div
            ...
            className={`w-full flex flex-col items-center justify-center gap-1.5 px-3 py-4 rounded-md border-2 border-dashed transition-colors ${
              dragOver
                ...
                : 'border-neutral-700 bg-[#1c1c1c] text-neutral-400'
            }`}
          >
          ...
          <div className="flex gap-1.5">
            <label
              htmlFor={fileInputId}
              className="flex-1 flex items-center justify-center gap-1 text-[11px] py-1.5 rounded-md border border-neutral-700 bg-[#1c1c1c] text-neutral-300 hover:border-neutral-600 hover:bg-[#161616] transition-colors cursor-pointer select-none"
            >
      ...
      {hasFile && isFolder && analyzing && (
        <div className="flex items-center justify-center gap-2 px-3 py-3 rounded-md border border-neutral-800 bg-[#1c1c1c]">
...
function IdmlSummaryPanel({ summary }: { summary: IdmlSummary }) {
  ...
  return (
    <div className="border border-neutral-800 rounded-md bg-[#1c1c1c] p-3 flex flex-col gap-2.5">

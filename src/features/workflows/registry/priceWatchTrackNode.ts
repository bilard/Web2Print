...
const priceWatchTrackNode: NodeSpec<TrackConfig, TrackInputs, { changes?: ExcelSheet; all: ExcelSheet }> = {
  ...
  configSchema: [
    ...
    { name: 'nameColumn', kind: 'columnRef', labelKey: 'node.price-watch-track.nameColumn.label', helpKey: 'node.price-watch-track.nameColumn.help' },
    ...
    { name: 'watchId', kind: 'text', labelKey: 'node.price-watch-track.watchId.label', helpKey: 'node.price-watch-track.watchId.help' },

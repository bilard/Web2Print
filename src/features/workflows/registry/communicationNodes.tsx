      ...
      <div>
        ...
        <div className="relative">
          ...
          {autocomplete?.open && suggestions.length > 0 && (
            <div className="absolute top-full left-0 right-0 mt-1 max-h-48 overflow-y-auto bg-[#303030] border border-cyan-500/40 rounded-md shadow-xl z-20">
        ...
        {config.attachmentMode === 'filtered' && (
          <div className="pt-1">
            ...
            <input
              ...
              className="w-full bg-[#242424] border border-neutral-700 rounded-md px-2 py-1 text-[11px] text-white placeholder:text-neutral-600 focus:border-cyan-500 outline-none"
            />
          </div>
        )}
      </div>

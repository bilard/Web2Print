...
const comparePricesNode: NodeSpec<ComparePricesConfig, ComparePricesInputs, ComparePricesOutputs> = {
  ...
  configSchema: [
    ...
    { name: 'eanColumn', kind: 'columnRef', labelKey: 'node.compare-prices.eanColumn.label', default: 'ean', helpKey: 'node.compare-prices.eanColumn.help' },
    { name: 'referenceColumn', kind: 'columnRef', labelKey: 'node.compare-prices.referenceColumn.label', default: '', helpKey: 'node.compare-prices.referenceColumn.help' },
    { name: 'urlColumn', kind: 'columnRef', labelKey: 'node.compare-prices.urlColumn.label', default: 'url', helpKey: 'node.compare-prices.urlColumn.help' },

...
const crawlNode: NodeSpec<CrawlConfig, Record<string, never>, CrawlOutputs> = {
  ...
  configSchema: [
    { name: 'urls', kind: 'textarea', labelKey: 'node.crawl.urls.label', required: true,
      helpKey: 'node.crawl.urls.help' },
    { name: 'limit', kind: 'number', labelKey: 'node.crawl.limit.label', default: 30, helpKey: 'node.crawl.limit.help' },
    ...
    { name: 'fields', kind: 'text', labelKey: 'node.crawl.fields.label', default: 'name,reference,ean,price,specifications,images,documents',
      helpKey: 'node.crawl.fields.help' },
  ],

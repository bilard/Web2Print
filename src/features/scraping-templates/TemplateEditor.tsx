...
export function TemplateEditor({ template, onChange, onSaved }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 bg-[#303030] border border-white/10 rounded-lg">
      ...
      <div className="sticky top-0 z-30 bg-[#303030] -mx-4 px-4 -mt-4 pt-4 pb-2 border-b border-white/10 flex items-center justify-between gap-3 flex-wrap">

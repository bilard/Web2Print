...
export const FIELD_TEMPLATES: Record<string, { label: string; fields: ScrapingField[] }> = {
  product: {
    ...
    fields: [
      ...
      { key: 'description', label: 'Description', description: 'Description ou accroche principale du produit recopiée VERBATIM depuis la page (mot pour mot, sans reformuler ni résumer), pas les accessoires', type: 'string' },
  ...
  product_tech: {
    ...
    fields: [
      ...
      { key: 'description', label: 'Description', description: 'Description du produit principal recopiée VERBATIM depuis la page (mot pour mot, sans reformuler ni résumer)', type: 'string' },
      { key: 'breadcrumb', label: 'Fil d\'Ariane', description: BREADCRUMB_DESCRIPTION, type: 'strings' },
      { key: 'brand', label: 'Marque', description: 'Marque ou fabricant', type: 'string' },
  ...
  product_full: {
    ...
    fields: [
      ...
      { key: 'description', label: 'Description', description: 'Description complète du produit principal recopiée VERBATIM depuis la page : toutes les phrases descriptives telles qu\'écrites par la source, mot pour mot. NE PAS tronquer, NE PAS reformuler, NE PAS résumer, NE PAS traduire.', type: 'string' },
      { key: 'breadcrumb', label: 'Fil d\'Ariane', description: BREADCRUMB_DESCRIPTION, type: 'strings' },

  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[61] flex items-center justify-center p-4 pointer-events-none">
        <div className="pointer-events-auto w-full max-w-3xl max-h-[90vh] bg-[#282828] border border-white/10 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden flex flex-col">
          ...
          <div className="px-5 py-4 space-y-4 flex-1 overflow-y-auto min-h-0">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#1c1c1c] border border-white/10 focus:border-violet-500/50 rounded-lg px-3 py-2 text-[13.5px] text-white placeholder:text-white/30 outline-none transition-colors"
                autoFocus
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={12}
                className="block w-full bg-[#1c1c1c] border border-white/10 focus:border-violet-500/50 rounded-lg px-3 py-2 text-[13px] text-white placeholder:text-white/30 outline-none resize-y font-mono transition-colors min-h-[180px]"
              />
            </div>
          </div>

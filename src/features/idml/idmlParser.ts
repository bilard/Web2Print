...
import type { IdmlColor, IdmlObject, IdmlParagraph, IdmlDocument, IdmlShadow, CharStyleOverride } from './idmlTypes'
export type { IdmlColor, IdmlObject, IdmlParagraph, IdmlDocument }
import { buildColorMap } from './idmlColors'
import { parseTf, mulMat, tfPoint, decompose, parsePathPoints, pathPointsToSvg, type Mat, type PathPoint } from './idmlGeometry'

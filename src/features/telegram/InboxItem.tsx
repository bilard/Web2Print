    ...
    >
      ...
      {editing ? (
        <div className="space-y-1.5">
          <textarea
            ...
            rows={2}
            className="w-full bg-background border border-cyan-500/40 rounded-md px-2 py-1 text-[13px] text-white outline-none resize-y"
          />
      ...
      {menuOpen && (
        <>
          ...
          <div className="absolute right-2 top-9 z-20 w-32 rounded-md border border-white/10 bg-surface shadow-xl py-1">
            {!isOut && (
              <button
                onClick={() => {
                  setEditing(true)

  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-2 gap-0 overflow-hidden">
        ...
        />
        <div className="p-4 overflow-auto bg-[#242424] prose prose-invert prose-sm max-w-none prose-headings:text-white/90 prose-a:text-indigo-300 prose-code:text-amber-300 prose-code:bg-white/5 prose-code:px-1 prose-code:rounded">

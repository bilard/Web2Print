            ...
            <div key={cat.id} className="border border-white/10 rounded-lg overflow-hidden">
              ...
              <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-white/5">
                ...
                <div className="relative group">
                  ...
                  <div className="hidden group-hover:flex absolute right-0 top-full mt-1 bg-surface-2 border border-white/15 rounded-lg p-1.5 gap-1 flex-wrap w-28 z-50 shadow-xl">

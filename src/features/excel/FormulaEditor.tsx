        ...
        <div className="flex-1 min-h-0 flex">
          ...
          <div className="flex-1 p-4 space-y-4 overflow-y-auto">
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full bg-[#212121] border border-white/10 rounded-lg px-3 py-2 text-sm text-white/80 outline-none focus:border-indigo-500/50"
            ...
            <div>
              ...
              <div className="bg-[#212121] border border-white/[0.06] rounded-lg divide-y divide-white/[0.04] max-h-[180px] overflow-y-auto">

    ...
    <div className="space-y-1.5 pt-1 border-t border-white/10">
      <div className="flex items-center gap-1.5">
        <button type="button" onClick={() => void cutoutAll()} disabled={running}
          title="Détoure le visuel de chaque produit sélectionné (fond supprimé, PNG transparent) — les images d'origine sont conservées"
        ...
        {running ? (
          <button type="button" onClick={cancel} title="Interrompre le détourage"

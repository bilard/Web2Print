...
export function DamSearchBar() {
  ...
  return (
    <div className="relative">
      <div className="flex items-center bg-surface-2 border border-white/10 rounded-lg h-9 px-3 gap-2 focus-within:border-indigo-500/50">
      ...
      {showDropdown && (
        <ul
          ...
          role="listbox"
          className="absolute top-full left-0 right-0 mt-1 bg-surface border border-white/10 rounded-lg py-2 z-50 shadow-xl overflow-hidden"
        >
          {suggestions.map((s, i) => {

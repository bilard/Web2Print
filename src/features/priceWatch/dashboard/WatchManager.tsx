...
// Modale « Gérer les suivis » : liste TOUS les suivis, chacun supprimable directement
// (sans avoir à le sélectionner d'abord — c'était la galère). Confirmation INLINE par
// ligne (pas de 2e modale imbriquée, qui casserait le focus/click-outside). Une seule
// surface (AlertDialog), réutilise deleteWatch.

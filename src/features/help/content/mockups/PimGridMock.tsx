...
export function PimGridMock() {
  return (
    <div className="w-full max-w-[460px] bg-surface border border-white/10 rounded-md overflow-hidden pointer-events-none">
      <div className="grid grid-cols-[80px_1fr_90px_70px_28px] gap-0 text-[10px] uppercase tracking-wider text-white/40 border-b border-white/10 bg-well">

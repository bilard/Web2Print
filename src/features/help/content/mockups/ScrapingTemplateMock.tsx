...
export function ScrapingTemplateMock() {
  return (
    <div className="w-full max-w-[440px] bg-surface border border-white/10 rounded-md overflow-hidden pointer-events-none">
      ...
      <div className="grid grid-cols-[1fr_120px]">
        <div className="p-3 bg-background border-r border-white/5">

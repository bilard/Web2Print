    ...
    <div className="relative">
      ...
      {showDropdown && (
        <>
          ...
          <div
            ref={dropdownRef}
            className="absolute top-full left-0 right-0 mt-1 z-20 bg-surface-2 border border-white/10 rounded-lg shadow-xl overflow-hidden max-h-56 overflow-y-auto"
          >
            {results.map((r) => (
              <button
                key={r.nodeId}

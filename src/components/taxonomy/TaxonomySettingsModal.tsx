...
export function TaxonomySettingsModal({ taxonomy, onClose }: TaxonomySettingsModalProps) {
  ...
  return (
    ...
    >
      <div
        className="w-[440px] bg-[#282828] border border-white/10 rounded-xl shadow-2xl overflow-hidden"
        ...
        <div className="p-4 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#1c1c1c] border border-white/10 rounded-lg px-3 py-2 text-[12px] text-white/90 placeholder:text-white/25 outline-none focus:border-indigo-500/60 transition-colors"
            />
            {sourceUrl.trim() && (
              <a
                href={sourceUrl.trim()}

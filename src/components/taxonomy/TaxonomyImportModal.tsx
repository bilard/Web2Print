...
export function TaxonomyImportModal({ open, onClose }: TaxonomyImportModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-[#282828] border border-white/10 rounded-xl shadow-2xl w-[560px] max-h-[80vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {step === 'upload' ? (
            ...
            <div>
              ...
              <div className="bg-[#212121] rounded-lg border border-white/[0.06] max-h-64 overflow-y-auto py-1">
                <DndContext>

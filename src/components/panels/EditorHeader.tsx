...
import { globalUndo, globalRedo } from '@/features/editor/globalCanvas'
...
export function EditorHeader() {
  ...
  return (
    <>
    <header data-tour="header" className="h-12 bg-surface border-b border-white/10 flex items-center px-3 gap-2 shrink-0 z-30">
      {/* Back */}
      <button

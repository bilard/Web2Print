...
function ImageMenuButton() {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div className="absolute left-full top-0 ml-2 bg-[#303030] border border-white/10 rounded-lg py-1 w-[170px] shadow-xl z-50">
...
export function ToolBar() {
  return (
    <div data-tour="toolbar" className="w-11 bg-[#303030] border-r border-white/10 flex flex-col items-center py-2 gap-0.5 shrink-0">
      {/* Group 1: Selection */}

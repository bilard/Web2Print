  ...
  return (
    <div className="flex flex-col gap-1.5 bg-surface-2 rounded p-2 border border-white/5">
      ...
      <div className="flex items-center gap-1.5">
        <span className="text-[10px] text-white/40 shrink-0">Si</span>
        ...
        <button onClick={onRemove} title="Supprimer la règle"
      ...
      <div className="flex items-center gap-1.5">
        ...
        {needsValue && (
          <input className={INPUT_CLS} value={rule.value ?? ''} placeholder="valeur"

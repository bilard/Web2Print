    ...
    <div className="bg-white/[0.03] rounded-xl flex flex-col">
      ...
      <div className="flex flex-col gap-1.5 mt-1">
        ...
        <div className="relative" ref={popoverRef}>
          ...
          {popoverOpen && (
            <div className="absolute z-10 mt-1 w-full bg-[#303030] border border-white/10 rounded-lg shadow-xl flex flex-col max-h-72">
              {showSearch && (
                <div className="sticky top-0 p-1.5 border-b border-white/5 bg-[#303030]">

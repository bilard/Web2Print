        ...
        <div
          ...
          className={`flex flex-col items-center gap-4 p-8 rounded-xl border-2 border-dashed cursor-pointer transition-all ${
            dragOver === 'idml'
              ...
              : 'border-white/10 hover:border-amber-500/40 bg-[#282828] hover:bg-[#1e1e1e]'
          }`}
        >
        ...
        <div
          ...
          className={`flex flex-col items-center gap-4 p-8 rounded-xl border-2 border-dashed cursor-pointer transition-all ${
            dragOver === 'pptx'
              ...
              : 'border-white/10 hover:border-orange-500/40 bg-[#282828] hover:bg-[#1e1e1e]'
          }`}
        >
        ...
        <div
          ...
          className={`flex flex-col items-center gap-4 p-8 rounded-xl border-2 border-dashed cursor-pointer transition-all ${
            dragOver === 'image'
              ...
              : 'border-white/10 hover:border-sky-500/40 bg-[#282828] hover:bg-[#1e1e1e]'
          }`}
        >
        ...
        <div
          ...
          className={`flex flex-col items-center gap-4 p-8 rounded-xl border-2 border-dashed cursor-pointer transition-all ${
            dragOver === 'svg'
              ...
              : 'border-white/10 hover:border-purple-500/40 bg-[#282828] hover:bg-[#1e1e1e]'
          }`}
        >
        ...
        <div
          ...
          className={`flex flex-col items-center gap-4 p-8 rounded-xl border-2 border-dashed cursor-pointer transition-all ${
            dragOver === 'xlsx'
              ...
              : 'border-white/10 hover:border-emerald-500/40 bg-[#282828] hover:bg-[#1e1e1e]'
          }`}
        >
        ...
        <div
          ...
          className={`flex flex-col items-center gap-4 p-8 rounded-xl border-2 border-dashed cursor-pointer transition-all ${
            dragOver === 'image-to-svg'
              ...
              : 'border-white/10 hover:border-pink-500/40 bg-[#282828] hover:bg-[#1e1e1e]'
          }`}
        >

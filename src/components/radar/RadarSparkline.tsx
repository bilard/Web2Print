...
/** Sparkline SVG responsive (ligne + aire optionnelle). Base des tracés de radarPrice. */
export function RadarSparkline({
  ...
  return (
    ...
    >
      ...
      {leadingDot && last && (
        <>
          <circle cx={last[0]} cy={last[1]} r={5} fill={stroke} opacity="0.25" className="radar-live-dot" />

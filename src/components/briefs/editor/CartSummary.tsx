...
export function CartSummary({ subtotal, total, discount, onDiscountChange }: Props) {
  return (
    <div className="border border-white/[0.06] rounded-md p-4 bg-surface-2 flex flex-col gap-3 text-[12px]">
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          className="bg-background border border-white/[0.08] rounded px-2 py-1 text-[11px] text-white"
        >
        ...
        <input
          ...
          className="bg-background border border-white/[0.08] rounded px-2 py-1 w-20 text-right text-[11px] text-white disabled:opacity-40"
        />
      </div>

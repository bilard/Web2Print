        ...
        <div className="flex flex-col gap-1">
          {briefs.map((b) => (
            <div
              ...
              className="group flex items-center gap-3 bg-[#2a2a2a] border border-white/[0.06] rounded-md px-3 py-2 cursor-pointer hover:border-indigo-500/40 transition-colors"
            >
...
function BriefThumbnailCard({ brief, onOpen, onDelete }: BriefThumbnailCardProps) {
  ...
  return (
    <div
      onClick={onOpen}
      className="group bg-[#2a2a2a] border border-white/[0.06] rounded-md overflow-hidden cursor-pointer hover:border-indigo-500/40 transition-colors"
    >

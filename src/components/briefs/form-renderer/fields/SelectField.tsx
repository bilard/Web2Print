  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <select
        ...
        disabled={disabled}
        className="bg-[#1c1c1c] border border-white/[0.08] rounded-md px-3 py-2 text-[13px] text-white focus:outline-none focus:border-indigo-500/60 disabled:opacity-50"
      >
        <option value="">—</option>
        {options.map((opt) => (

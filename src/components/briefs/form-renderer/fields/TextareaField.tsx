  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        ...
        disabled={disabled || improve.isPending}
        rows={4}
        className="bg-[#1c1c1c] border border-white/[0.08] rounded-md px-3 py-2 text-[13px] text-white placeholder:text-white/25 focus:outline-none focus:border-indigo-500/60 disabled:opacity-50 resize-y"
      />
      {field.helpText && (

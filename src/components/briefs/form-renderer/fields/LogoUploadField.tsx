    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="w-16 h-16 rounded-md bg-[#1c1c1c] border border-white/[0.08] hover:border-indigo-500/60 flex items-center justify-center overflow-hidden disabled:opacity-50 transition-colors"
        >
          {uploading ? (
        ...
        <input
          ...
          placeholder="https://..."
          disabled={disabled}
          className="flex-1 bg-[#1c1c1c] border border-white/[0.08] rounded-md px-3 py-2 text-[13px] text-white placeholder:text-white/25 focus:outline-none focus:border-indigo-500/60 disabled:opacity-50"
        />
        <input
          ref={inputRef}
          type="file"

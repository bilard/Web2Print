...
| `extracted/tokens.json` | Design tokens: 7 colors, 1 fonts, 1 headings, 0 CTAs |
...
- **Colors**: #0F0F0F, #F2F2F2, #1A1A1A, #333333, #FFFFFF, #1F2937, #6366F1
- **Fonts**: -apple-system (400,500,700)

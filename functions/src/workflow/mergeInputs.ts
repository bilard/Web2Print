// functions/src/workflow/mergeInputs.ts
...
// sheet pleine. ⚠️ Logique DUPLIQUÉE À L'IDENTIQUE côté client
// (src/features/workflows/runtime/mergeInputs.ts) : parité client/serveur obligatoire.

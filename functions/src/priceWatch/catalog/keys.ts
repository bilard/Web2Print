 ...
 * (`explorer/confidence`, côté client) doivent tracer la MÊME frontière — deux seuils
 * recopiés divergent, et l'écran expliquerait alors un appariement que le moteur ne fait
 * plus.
 */

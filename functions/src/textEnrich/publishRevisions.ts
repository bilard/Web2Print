// functions/src/textEnrich/publishRevisions.ts
// ⚠ COPIE du client — toute modification doit être reportée des deux côtés.
// Comparé au TEXTE par src/features/textEnrich/textEnrichParity.test.ts

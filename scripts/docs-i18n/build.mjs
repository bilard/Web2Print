...
const L = {
  en: {
    ...
    ui: [
      ...
      ["title=\"Animations de la page d'accueil\"", 'title="Home page animations"'],
  ...
  es: {
    ...
    ui: [
      ...
      ["title=\"Animations de la page d'accueil\"", 'title="Animaciones de la página de inicio"'],
  ...
  de: {
    ...
    ui: [
      ...
      ["title=\"Animations de la page d'accueil\"", 'title="Animationen der Startseite"'],
  ...
  it: {
    ...
    ui: [
      ...
      ["title=\"Animations de la page d'accueil\"", 'title="Animazioni della home page"'],

...
| 4 | **Score de complétude PIM + fraîcheur des champs** — jauge par produit, pastilles d'âge de scrape | ✅ livré — complétude 2026-06-11 (`25e3f34`) : pastille/ligne + moyenne globale (DataTable) ; **fraîcheur par champ 2026-06-13** : `ProductField.updatedAt` stampé au changement de valeur (mergeStrategy), pastille ambre ≥ 30 j / rouge ≥ 90 j par cellule (`fieldFreshness.ts`) — produits antérieurs sans timestamp = pas de pastille jusqu'au prochain merge |
